...
public class ShopBikesFragment extends Fragment {
    ...
    @Nullable
    public static ShopBikesFragment newInstance() {
        ShopBikesFragment fragment = new ShopBikesFragment();
        return fragment;
    }
...
GetData();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ShopBikesFragment(), "Featured");
        adapter.addFragment(new ShopHomeFragment(), "Offer");
        adapter.addFragment(new ShopBikesFragment(), "Cars");
