...
public class ShopJetFragment extends Fragment {
    ...
    @Nullable
    public static ShopJetFragment newInstance() {
        ShopJetFragment fragment = new ShopJetFragment();
        return fragment;
    }
...
GetData();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ShopJetFragment(), "Featured");
        adapter.addFragment(new ShopHomeFragment(), "Offer");
        adapter.addFragment(new ShopJetFragment(), "Cars");
