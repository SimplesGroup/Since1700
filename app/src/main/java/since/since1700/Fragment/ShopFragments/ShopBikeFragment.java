...
public class ShopBikeFragment extends Fragment {
    ...
    int requestcount=1;
    String ITEMURL="https://androiddevelopmentnew.000webhostapp.com/bike.json";
    private boolean loading;
    protected Handler handler;
    ProgressDialog pdialog;

    @Nullable
    public static ShopBikeFragment newInstance() {
        ShopBikeFragment fragment = new ShopBikeFragment();
        return fragment;
    }
...
GetData();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ShopBikeFragment(), "Featured");
        adapter.addFragment(new ShopHomeFragment(), "Offer");
        adapter.addFragment(new ShopBikeFragment(), "Cars");
