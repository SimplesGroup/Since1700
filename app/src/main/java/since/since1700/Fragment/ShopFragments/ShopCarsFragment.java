...
public class ShopCarsFragment extends Fragment {
    ...
    @Nullable
    public static ShopCarsFragment newInstance() {
        ShopCarsFragment fragment = new ShopCarsFragment();
        return fragment;
    }
...
GetData();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ShopCarsFragment(), "Featured");
