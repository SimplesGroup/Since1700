...
public class ShopJewelleryFragment extends Fragment {
    ...
    int requestcount=1;
    String ITEMURL="https://androiddevelopmentnew.000webhostapp.com/brand/jewel.json";
    private boolean loading;
    protected Handler handler;
    ProgressDialog pdialog;

    @Nullable
    public static ShopJewelleryFragment newInstance() {
        ShopJewelleryFragment fragment = new ShopJewelleryFragment();
        return fragment;
    }
...
GetData();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ShopJewelleryFragment(), "Featured");
        adapter.addFragment(new ShopHomeFragment(), "Offer");
        adapter.addFragment(new ShopJewelleryFragment(), "Cars");
