...
import since.since1700.Fragment.ShopFragments.ShopBikeFragment;
import since.since1700.Fragment.ShopFragments.ShopCarFragment;
...
import since.since1700.Fragment.ShopFragments.ShopJetsFragment;
...
*/
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ShopCarFragment(), "Cars");
        adapter.addFragment(new ShopBikeFragment(), "Bike");
        adapter.addFragment(new ShopBikeFragment(), "Jet");
