...
public class AstonMartinFeedbrand extends Fragment {

    @Nullable
    public static AstonMartinFeedbrand newInstance() {
        AstonMartinFeedbrand fragment = new AstonMartinFeedbrand();
        return fragment;
    }
    ...
    String ITEMURL = "https://androiddevelopmentnew.000webhostapp.com/brand/astonmartin.json";
