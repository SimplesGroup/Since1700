...
/**
 * Created by Sandhiya on 11/16/2017.
 */
...
public class Rewards extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.profile_rewards,container,false);
    ...
    public  class ProductAdapterFeed extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == VIEW_TYPE_ITEM) {
                View view = LayoutInflater.from(getActivity()).inflate(R.layout.profile_rewards_items, parent, false);
                return  new Favourites.Itemviewholder(view);
            } else if (viewType == VIEW_TYPE_LOADING) {
                View view = LayoutInflater.from(getActivity()).inflate(R.layout.layout_loading_item, parent, false);
                return new Favourites.LoadingViewHolder(view);
            }
            return null;
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof Favourites.Itemviewholder) {
                if (mImageLoader == null)
                    mImageLoader = MySingleton.getInstance(getActivity()).getImageLoader();

                final Favourites.Itemviewholder userViewHolder = (Favourites.Itemviewholder) holder;
                ...
                if (holder instanceof Favourites.LoadingViewHolder) {
                    Favourites.LoadingViewHolder loadingViewHolder = (Favourites.LoadingViewHolder) holder;
